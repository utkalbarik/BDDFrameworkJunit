...
@CucumberOptions
(features = {"D:\\Pavan_JavaPractice\\Automation\\BDDFramework\\src\\main\\java\\com\\crm\\qa\\Features\\LoginFeature.feature"}, //Path of the Feature Files.
glue= {"com.crm.qa.StepDefinitions"}, //Path of the Step Definition Files.
format = {"pretty", "html:test-output", "junit:junit_xml/cucumber.xml"}, //Generate Output in Different types of Reports.
